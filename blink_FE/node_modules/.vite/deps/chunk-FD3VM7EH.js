...
function createGrid(options = {}) {
  ...
  const OverflowContext = React17.createContext(void 0);
  ...
  const Grid2 = React17.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React17.useContext(OverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime4.jsx)(GridRoot, _extends({
      ref,
      as: component,
      ownerState,
      ...
      children: React17.Children.map(children, (child) => {
        if (React17.isValidElement(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime4.jsx)(OverflowContext.Provider, {
...
var _excluded9 = ["colorSchemes", "components"];
    ...
    Object.entries(palette2).forEach((entry) => {
      ...
      if (isVariantPalette(colorPalette) && typeof colorPalette === "object") {
        result = _extends({}, result, {
          [color2]: createVariantStyle(variant, colorPalette, (variantVar) => getCssVar(`palette-${color2}-${variantVar}`, palette2[color2][variantVar]))
        });
      }
    });
  }
...
var createSoftInversion = (theme, addDefaultValues) => {
  ...
  const getCssVar = addDefaultValues ? (cssVar) => {
    ...
    return getCssVarDefault(cssVar, (_theme$palette = theme.palette) == null || (_theme$palette = _theme$palette[color2]) == null ? void 0 : _theme$palette[value]);
  } : getCssVarDefault;
    ...
    if (isVariantPalette(colorPalette)) {
      result[color2] = {
        ...
        [theme.getColorSchemeSelector("dark")]: {
          [prefixVar("--palette-focusVisible")]: getCssVar(`palette-${color2}-300`),
          [prefixVar("--palette-background-body")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.1)`,
          [prefixVar("--palette-background-surface")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.08)`,
          [prefixVar("--palette-background-level1")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.2)`,
          [prefixVar("--palette-background-level2")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.4)`,
          [prefixVar("--palette-background-level3")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.6)`,
          [prefixVar("--palette-text-primary")]: getCssVar(`palette-${color2}-100`),
          [prefixVar("--palette-text-secondary")]: `rgba(${getCssVar(`palette-${color2}-lightChannel`)} / 0.72)`,
          [prefixVar("--palette-text-tertiary")]: `rgba(${getCssVar(`palette-${color2}-lightChannel`)} / 0.6)`,
          [prefixVar("--palette-text-icon")]: `rgba(${getCssVar(`palette-${color2}-lightChannel`)} / 0.6)`,
          [prefixVar("--palette-divider")]: `rgba(${getCssVar(`palette-${color2}-lightChannel`)} / 0.2)`,
          ...
          "--variant-softColor": getCssVar(`palette-${color2}-200`),
          ...
          "--variant-solidHoverBg": getCssVar(`palette-${color2}-600`),
        ...
        [theme.getColorSchemeSelector("light")]: {
          [prefixVar("--palette-focusVisible")]: getCssVar(`palette-${color2}-500`),
          [prefixVar("--palette-background-body")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.1)`,
          [prefixVar("--palette-background-surface")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.08)`,
          [prefixVar("--palette-background-level1")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.2)`,
          [prefixVar("--palette-background-level2")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.32)`,
          [prefixVar("--palette-background-level3")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.48)`,
          [prefixVar("--palette-text-primary")]: getCssVar(`palette-${color2}-700`),
          [prefixVar("--palette-text-secondary")]: `rgba(${getCssVar(`palette-${color2}-darkChannel`)} / 0.8)`,
          [prefixVar("--palette-text-tertiary")]: `rgba(${getCssVar(`palette-${color2}-darkChannel`)} / 0.68)`,
          [prefixVar("--palette-text-icon")]: getCssVar(`palette-${color2}-400`),
          [prefixVar("--palette-divider")]: `rgba(${getCssVar(`palette-${color2}-mainChannel`)} / 0.32)`,
          "--variant-plainColor": `rgba(${getCssVar(`palette-${color2}-darkChannel`)} / 0.8)`,
          "--variant-plainHoverColor": `rgba(${getCssVar(`palette-${color2}-darkChannel`)} / 1)`,
          ...
          "--variant-softBg": `rgba(${getCssVar(`palette-${color2}-lightChannel`)} / 0.8)`,
          ...
          "--variant-solidBg": getCssVar(`palette-${color2}-${color2 === "neutral" ? "700" : "500"}`),
          "--variant-solidHoverColor": getCssVar("palette-common-white"),
          "--variant-solidHoverBg": getCssVar(`palette-${color2}-${color2 === "neutral" ? "600" : "600"}`),
          "--variant-solidActiveBg": getCssVar(`palette-${color2}-${color2 === "neutral" ? "600" : "600"}`),
...
var createSolidInversion = (theme, addDefaultValues) => {
  ...
  const getCssVar = addDefaultValues ? (cssVar) => {
    ...
    const color2 = tokens[1];
    const value = tokens[2];
    return getCssVarDefault(cssVar, theme.palette[color2][value]);
  } : getCssVarDefault;
  Object.entries(theme.palette).forEach((entry) => {
    const [color2, colorPalette] = entry;
    if (isVariantPalette(colorPalette)) {
      result[color2] = {
        ...
        [prefixVar("--palette-focusVisible")]: getCssVar(`palette-${color2}-200`),
        [prefixVar("--palette-background-body")]: "rgba(0 0 0 / 0.1)",
        [prefixVar("--palette-background-surface")]: "rgba(0 0 0 / 0.06)",
        [prefixVar("--palette-background-popup")]: getCssVar(`palette-${color2}-700`),
        [prefixVar("--palette-background-level1")]: `rgba(${getCssVar(`palette-${color2}-darkChannel`)} / 0.2)`,
        [prefixVar("--palette-background-level2")]: `rgba(${getCssVar(`palette-${color2}-darkChannel`)} / 0.36)`,
        [prefixVar("--palette-background-level3")]: `rgba(${getCssVar(`palette-${color2}-darkChannel`)} / 0.6)`,
        [prefixVar("--palette-text-primary")]: getCssVar(`palette-common-white`),
        [prefixVar("--palette-text-secondary")]: getCssVar(`palette-${color2}-200`),
        [prefixVar("--palette-text-tertiary")]: getCssVar(`palette-${color2}-300`),
        [prefixVar("--palette-text-icon")]: getCssVar(`palette-${color2}-200`),
        [prefixVar("--palette-divider")]: `rgba(${getCssVar(`palette-${color2}-lightChannel`)} / 0.32)`,
        ...
        "--variant-solidColor": getCssVar(`palette-${color2}-${color2 === "neutral" ? "600" : "500"}`),
        "--variant-solidBg": getCssVar(`palette-common-white`),
        "--variant-solidHoverBg": getCssVar(`palette-common-white`),
        "--variant-solidActiveBg": getCssVar(`palette-${color2}-100`),
...
var _excluded12 = ["cssVarPrefix", "breakpoints", "spacing", "components", "variants", "colorInversion", "shouldSkipGeneratingVar"];
...
function extendTheme(themeOptions) {
  ...
  const createLightModeVariantVariables = (color2) => ({
    ...
    plainHoverBg: getCssVarColor(`palette-${color2}-50`),
    plainActiveBg: getCssVarColor(`palette-${color2}-100`),
    ...
    softDisabledBg: getCssVarColor(`palette-${color2}-50`),
    ...
    solidDisabledBg: getCssVarColor(`palette-${color2}-100`)
  });
  const createDarkModeVariantVariables = (color2) => ({
    ...
    softDisabledBg: getCssVarColor(`palette-${color2}-900`),
    solidColor: getCssVarColor(`palette-common-white`),
    solidBg: getCssVarColor(`palette-${color2}-500`),
    solidHoverBg: getCssVarColor(`palette-${color2}-600`),
    solidActiveBg: getCssVarColor(`palette-${color2}-700`),
    solidDisabledColor: getCssVarColor(`palette-neutral-500`),
    solidDisabledBg: getCssVarColor(`palette-${color2}-800`)
  });
  ...
  const defaultScales = {
    ...
    typography: {
      ...
      h4: {
        ...
        lineHeight: getCssVar(`lineHeight-lg, ${lineHeight2.lg}`),
        letterSpacing: "-0.025em",
        color: getCssVar(`palette-text-primary, ${lightColorSystem.palette.text.primary}`)
      },
      "title-lg": {
        ...
        lineHeight: getCssVar(`lineHeight-xl, ${lineHeight2.xl}`),
        color: getCssVar(`palette-text-primary, ${lightColorSystem.palette.text.primary}`)
      },
      "title-md": {
        fontFamily: getCssVar(`fontFamily-body, ${fontFamily2.body}`),
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FD3VM7EH.js.map
